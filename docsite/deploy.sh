...
echo "▸ verifying $URL"
fail=0
for p in / /install /workbench /assets/td-shell.css /assets/td-shell.js /assets/td-glass.js /assets/fonts/fonts.css /assets/fonts/inter-latin.woff2 /favicon.svg; do
