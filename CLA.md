...
Thank you for your interest in contributing to **Terminal Delight** ("the Project"),
...
then-current open-source license (the MIT License). The additional rights granted to
the Maintainer in Sections 2 and 3 exist **alongside**, and do not diminish, that
public license. The free and open-source distribution of Terminal Delight for individual
