...
REQUIREMENTS = {
    ...
    "zero_width": ("An embedder can read the combining marks or grapheme cluster attached to a cell, not only its first character.", "must"),
    ...
    "scrollback_read": ("An embedder can read lines that have scrolled off the top into history, not only the visible screen.", "must"),
