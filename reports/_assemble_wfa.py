#!/usr/bin/env python3
"""Assemble the bench-tenancy brief: inline every asset so the file survives being emailed."""
from pathlib import Path

SKILL = Path("/home/parker/.claude/skills/decision-brief")
HERE = Path(__file__).parent
NAME = "2026-09-21-bench-tenancy.html"
OUT = HERE / NAME
...
local_css = (HERE / "_wfa_style.css").read_text()
body = (HERE / "_wfa_body.html").read_text()
...
<title>Bench tenancy — terminal-delight, 2026-09-21</title>
<style>
{base_css}
{notes_css}
{local_css}
