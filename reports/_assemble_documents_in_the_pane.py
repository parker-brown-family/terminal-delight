#!/usr/bin/env python3
"""Assemble reports/2026-09-24-documents-in-the-pane.html — Gate 2 of the GUI-in-the-TUI plan.
...
OUT = HERE / "2026-09-24-documents-in-the-pane.html"
...
body = (HERE / "_documents_in_the_pane_body.html").read_text()
...
<title>Documents in the Pane</title>
<style>
{base_css}
{notes_css}
{brief_css}
