#!/usr/bin/env python3
"""Assemble reports/2026-09-21-the-parallel-transcript.html.
...
OUT = HERE / "2026-09-21-the-parallel-transcript.html"
...
body = (HERE / "_ws_body.html").read_text()
...
<title>The parallel transcript — one .ws file per conversation</title>
<style>
{base_css}
{notes_css}
{brief_css}
