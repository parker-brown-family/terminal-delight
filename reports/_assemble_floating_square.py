#!/usr/bin/env python3
"""Assemble reports/2026-09-24-floating-square.html — the build of documents in the pane.
...
OUT = HERE / "2026-09-24-floating-square.html"
...
body = (HERE / "_floating_square_body.html").read_text()
...
body = body.replace("{{soakchart}}", soak_chart())
